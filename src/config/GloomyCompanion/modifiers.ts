...
export const MODIFIER_CARDS: {[key in keyof typeof CARD_TYPES_MODIFIER]: ModifierCard} = {
...
export type ModifierCardType = typeof CARD_TYPES_MODIFIER[keyof typeof CARD_TYPES_MODIFIER];
